    ...
    <section className="flex justify-center px-4 sm:px-6 md:px-12 lg:px-24 pt-24 pb-8">
      <div className="flex flex-col lg:flex-row items-center max-w-6xl w-full lg:gap-16">
        ...
        <div className="lg:w-1/2 text-left">
          ...
          >
            Connect with healthcare professionals in real-time -- secure,
            high-quality video calls for instant medical advice and support,
            right from Health Vault!
          </motion.p>
        </div>
          ...
          <div className="relative w-56 h-56 sm:w-64 sm:h-64">
            ...
            >
              <div className="bg-card p-6 rounded-2xl border border-border shadow-lg relative overflow-hidden">
                ...
                <p className="mt-2 text-xs font-medium text-text text-center">Live</p>
              </div>
            </motion.div>
